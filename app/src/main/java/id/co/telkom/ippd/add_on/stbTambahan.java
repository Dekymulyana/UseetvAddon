...
public class stbTambahan extends AppCompatActivity {
    ...
    //var url parameter
    public String LOAD_BASE_URL = "http://10.0.8.56/addon/stbTambahan/";
    ...
    private class VersionCheck extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void result) {
            ...
            {
                final Dialog dialogUpdate = new Dialog(stbTambahan.this);
